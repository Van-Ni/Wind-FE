  ...
  useEffect(() => {
    if (isLoggedIn) {
      ...
      socket.on("start_chat", (data) => {
        console.log('🚀 ~ socket.on ~ start_chat:', data)
      ...
      socket.on("request_not_found", (data) => {
        dispatch(showSnackbar({ severity: "success", message: data.message }));
      });
      socket.on("deny_success", (data) => {
        dispatch(showSnackbar({ severity: "success", message: data.message }));
      });
      socket.on("request_accepted", (data) => {
        dispatch(showSnackbar({ severity: "success", message: data.message }));
      });
      socket.on("socket_request_error", (data) => {
      ...
      return () => {
        ...
        socket?.off("request_not_found");
        socket?.off("deny_success");
        socket?.off("request_accepted");
        socket?.off("socket_request_error");
      };
    }
